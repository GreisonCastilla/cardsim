...
interface GraveyardWidgetProps {
  pid: PlayerId;
...
export function GraveyardWidget({
  pid,
  zones,
  cards,
  handleCardHover,
  handleContextMenu,
}: GraveyardWidgetProps) {
  const graveKey = `${pid}_cemetery` as ZoneName;
  const cardIds = zones[graveKey] || [];
  ...
  return (
    <div className="relative flex flex-col items-center select-none">
      ...
      <motion.div
        ...
        whileHover={{ scale: 1.05, filter: "brightness(1.1) drop-shadow(0 0 15px rgba(239,68,68,0.5))" }}
        whileTap={{ scale: 0.95 }}
        className={cn(
          ...
          (isOpen || isOver) && "drop-shadow-[0_0_15px_rgba(239,68,68,0.6)] border-red-500/50",
          isOver && "bg-red-500/20 ring-2 ring-red-500 ring-offset-2 ring-offset-transparent"
        )}
        onClick={(e) => {
          e.stopPropagation();
          setIsOpen(!isOpen);
      ...
      >
        {topCardId ? (
          <div className="w-full h-full relative">
            ...
            />
            {totalCards > 1 && (
              <div className="absolute top-1 right-1 bg-red-600 text-white text-[7px] font-black px-1 rounded-sm shadow-lg border border-red-400 z-10">
                {totalCards}
              </div>
            )}
          </div>
              ...
              >
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    isOver ? "border-red-500 shadow-[0_0_50px_rgba(239,68,68,0.5)] scale-105" : "border-red-900 shadow-[0_0_40px_rgba(239,68,68,0.3)]",
                      ...
                      cardIds.map((id) => {
                        ...
                        return (
                          <motion.div
                            ...
                            onContextMenu={(e) => handleContextMenu(e, card, graveKey)}
                          >
                            <div className="w-[48px] h-[64px] relative flex items-center justify-center">
                              <Card
                                ...
                                zone={graveKey}
                                isStatic
                                onHover={(c) => handleCardHover(c, graveKey)}
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    isOver ? "border-t-red-500" : "border-t-red-900"
                  )}
